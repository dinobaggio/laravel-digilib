    ...
    @if ($files->total() != 0)
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="javascript:view('{{ route('dosen.file', ['file_id'=> $file->id_file]) }}')" class="btn btn-primary">Detail</a>
                <a href="javascript:view('{{ route('dosen.edit_jurnal', ['file_id'=> $file->id_file]) }}')" class="btn btn-info">Edit</a>
            </div>
        </div>
        <br>
        @endforeach
